# -*- coding: utf-8 -*-
"""
Created on Wed Sep 14 09:46:20 2022
...
def lightcurve(x):   
    ...
    #print(CF)
    print(curve)
    curve.write("C:/Users/samad/OneDrive/Desktop/KMooley Internship/Light Curves/Light_Curve_CF_"+str(x)+".ecsv", overwrite = True)
